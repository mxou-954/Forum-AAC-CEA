      ...
      <div className="overlow_rules">
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            ...
            utilisez notre forum. Nous nous engageons à protéger votre vie
            privée et à traiter vos données personnelles en toute transparence.
        ...
        <div style={sectionStyle}>
          ...
          <p style={textStyle}>
            En accédant et en utilisant notre forum, vous acceptez de vous
            conformer à nos conditions générales d'utilisation. Cela inclut le
            respect des autres utilisateurs, l'interdiction de publier du
            contenu illégal, et l'engagement de ne pas compromettre la sécurité
            du site. Nous nous réservons le droit de modifier ces conditions à
            tout moment, donc veuillez les consulter régulièrement.
          </p>
        </div>
        <div style={sectionStyle}>
          <h2 style={headerStyle}>Droits d'auteur et crédits</h2>
          <p style={textStyle}>
            Tous les contenus présents sur le site, tels que les textes,
            graphiques, logos, etc., sont la propriété de l'éditeur du site ou
            sont utilisés avec permission et sont protégés par les lois sur le
            droit d'auteur. L'utilisation non autorisée de ces contenus sans
            permission explicite est strictement interdite.
          </p>
        </div>
      </div>
    </div>
